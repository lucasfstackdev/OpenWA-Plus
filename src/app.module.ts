...
import { KirvanoModule } from './modules/kirvano/kirvano.module';
...
@Module({
  imports: [
      ...
      useFactory: (configService: ConfigService) => {
        ...
        const baseConfig = {
          entities: [
            ...
            __dirname + '/modules/kirvano/**/*.entity{.ts,.js}',
          ],
    ...
    KirvanoModule, // per-session Kirvano webhook event -> message template mapping
